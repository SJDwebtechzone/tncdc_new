...
const API_URL = `${BASE_URL}/api/inventory-categories`;
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <h1 className="text-2xl font-bold text-gray-800">Manage Inventory Categories</h1>
                <Button
                    ...
                    <div className="bg-white w-full max-w-md rounded-sm shadow-2xl relative">
                        <div className="flex items-center justify-between p-4 border-b">
                            <h2 className="text-sm font-normal text-gray-800">
                                {editingId ? 'Edit Inventory Category' : 'Add New Inventory Category'}
                            </h2>
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-6">
                            <div className="space-y-1">
                                <label className="text-[11px] font-bold text-gray-700">Category Name</label>
                                <Input 
            ...
            {deleteConfirm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white w-full max-w-sm rounded-sm shadow-2xl p-6 text-center space-y-4">
                        ...
                        <h3 className="text-sm font-bold text-gray-800">Delete Category?</h3>
                        <p className="text-xs text-gray-500">Are you sure you want to delete this category? This action cannot be undone.</p>
                        <div className="flex justify-center gap-3 pt-2">
                            <Button
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50/50 hover:bg-gray-50/50 border-b border-gray-200">
                                ...
                                <TableHead className="font-bold text-gray-800 text-xs uppercase py-5">Category Name</TableHead>
